...
insert into products (name, description, code, price) values ('Snoep', 'Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id.', '816905633-0', 10.5);
insert into products (name, description, code, price) values ('Chocolade', 'Nulla ut erat id mauris vulputate elementum. Nullam varius.', '077030122-3', 11);
